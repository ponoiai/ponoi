...
export function Icon({ name, size, className }: { name: string; size?: number; className?: string }) {
  ...
  switch (name) {
    ...
    case 'mic-off': return <svg {...p}><line x1="2" y1="2" x2="22" y2="22"/><path d="M9 9v3a3 3 0 0 0 5.12 2.12M15 9.34V4a3 3 0 0 0-5.94-.6"/><path d="M17 16.95A7 7 0 0 1 5 12v-2m14 0v2a7 7 0 0 1-.11 1.23"/><line x1="12" y1="19" x2="12" y2="23"/></svg>
    ...
    case 'headphones-off': return <svg {...p}><line x1="2" y1="2" x2="22" y2="22"/><path d="M3 18v-6a9 9 0 0 1 12.09-8.44M21 15.15V12a9 9 0 0 0-.35-2.5"/><path d="M6 14H5a2 2 0 0 0-2 2v3a2 2 0 0 0 2 2h1a2 2 0 0 0 2-2v-3"/><path d="M18 14h1a2 2 0 0 1 2 2v3"/></svg>
